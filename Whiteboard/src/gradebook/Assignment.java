...
public class Assignment {
    ...
    /** String representing this assignment's type, eg. test, quiz, homework,
     * etc */
    private String kind;
     ...
     * 
     * @param id
     *            a User representing the Student whose grade is being
     *            retrieved.
     * @return an Double representing the student's score out of
     *         this.possiblePoints. */
     ...
     * 
     * @return a Double representing the mean grade out of
     *         this.possiblePoints */
    ...
    /** Adds a new Student and their grade to this assignment If the student
     * already has a grade, the old one is overridden
     * 
     * @param id
     *            the User's id whose grade is being added
     * @param score
     *            the grade the student received out of totalPossiblePoints */
    protected void addGrade(String id, double score) {
        grades.put(id, score);
    }
    
    /** sets given Student's grade for this assignment to given double If the
     * student doesn't have a grade, this one is inserted
     * 
     * @param id
     *            the User's id whose grade is being added
     * @param score
     ...
     * 
     * @param obj
     *            The Object equality is being checked against
     ...
     * 
     * @param n
     *            a String containing the new name for this assignment */
     ...
     * 
     * @param d
     *            a String containing the new description for this
     *            assignment. */
     ...
     * 
     * @param k
     *            a String containing the new type for this assignment. */
     ...
     * 
     * @return a double representing the total points possible for this
     *         assignment */
    protected double getTotalPointsPossible() {
        return this.totalPointsPossible;
    }
    
    /** Sets the total points possible for this assignment to given double,
     * p.
     * 
     * @param p
     *            a double representing the new total points for this
     *            assignment. */
     ...
     * 
     * @param w
     *            the new Weight for this Assignment */
    protected void setWeight(double w) {
        this.weight = w;
    }
    
    /** Gets a map representing the grades for all students on this
     * assignment.
     * 
     * @return A map from student ID numbers, as an int, to grades, as an
     *         int. */
