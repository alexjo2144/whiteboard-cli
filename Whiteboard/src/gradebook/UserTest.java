...
public class UserTest {
    ...
    public void testSetFirstName() {
        ...
        assertEquals(s0, new Student("Ron", "F", "Weasley", "1", "2015",
                "password"));
        assertEquals(s1, new Student("Ginny", "G", "Weasley", "2", "2018",
                "password"));
    ...
    public void testSetAdvisor() {
        s0.setAdvisor("Bob");
        s1.setAdvisor("Bill");
        assertEquals(s0, new Student("George", "F", "Bob", "1", "2015",
                "password"));
        assertEquals(s1, new Student("Fred", "G", "Bill", "2", "2018",
                "password"));
    }
    ...
    public void testSetLastName() {
        ...
        assertEquals(s0, new Student("George", "Potter", "Weasley", "1",
                "2015", "password"));
        assertEquals(s1, new Student("Fred", "Granger", "Weasley", "2",
                "2018", "password"));
    ...
    public void testSetID() {
        ...
        t0.setID("3");
        t1.setID("4");
        assertEquals(s0, new Student("George", "F", "Weasley", "3", "2015",
                "password"));
        assertEquals(s1, new Student("Fred", "G", "Weasley", "4", "2018",
                "password"));
    ...
    public void testSetPassword() {
        ...
        assertEquals(s0, new Student("George", "F", "Weasley", "1", "2015",
                "password0"));
        assertEquals(s1, new Student("Fred", "G", "Weasley", "2", "2018",
                "password1"));
        assertEquals(t0, new Teacher("George", "Weasley", "1", "password2"));
        assertEquals(t1, new Teacher("Fred", "Weasley", "2", "password3"));
    }
    
    /** Testing for User.equals() */
    @Test
    public void testEquals() {
        assertTrue(s0.equals(new Student("George", "F", "Weasley", "1",
                "2015", "password")));
        assertTrue(s1.equals(new Student("Fred", "G", "Weasley", "2", "2018",
                "password")));
        assertTrue(t0
                .equals(new Teacher("George", "Weasley", "1", "password")));
        assertTrue(t1.equals(new Teacher("Fred", "Weasley", "2", "password")));
